...
function App() {
  ...
  // Funkcja do generowania losowego tokena
  const generateRandomContractDetails = useCallback(() => {
    // Przykładowe losowe nazwy i symbole
    const names = [
    ...
    // Generowanie prostego szablonu kontraktu bezpośrednio
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                Checking if your wallet has at least 100,000 $MAT tokens...
              </div>
            </div>
          </div>
        </Panel>
        ...
        <Panel theme={currentTheme} title="$MAT Token Required">
          <div style={{
            ...
            <div style={{
              ...
              <p>To use zer0 AI Assistant, you need to hold at least 100,000 $MAT tokens.</p>
              <p style={{ marginTop: '12px' }}>$MAT token was created in honor of Mike's cat, get some to support the project!</p>
            </div>
            <Button
            ...
            <div style={{
              ...
              After getting at least 100,000 $MAT tokens, refresh the page or reconnect your wallet.
            </div>
          </div>
        </Panel>
      ) : (
        <>
          ...
          {deploymentStatus.step > 0 && (
            <DeploymentResult
              ...
              theme={currentTheme}
              approveTokensForPool={approveTokensForPool}
